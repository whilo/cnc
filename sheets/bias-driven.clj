...
;; @@
;; =>
;;; {"type":"vega","content":{"width":600,"height":370.82818603515625,"padding":{"bottom":20,"top":10,"right":10,"left":50},"scales":[{"name":"x","type":"ordinal","range":"width","domain":{"data":"f5e13766-22e8-4256-9f18-82280889ec4a","field":"data.x"}},{"name":"y","range":"height","nice":true,"domain":{"data":"f5e13766-22e8-4256-9f18-82280889ec4a","field":"data.y"}}],"axes":[{"scale":"x","type":"x"},{"scale":"y","type":"y"}],"data":[{"name":"f5e13766-22e8-4256-9f18-82280889ec4a","values":[{"x":[0,0],"y":0.218757199999952},{"x":[0,1],"y":0.17091220000004792},{"x":[1,0],"y":0.340542800000048},{"x":[1,1],"y":0.26978779999995206}]},{"name":"9969195e-ef08-4973-846d-373ca920a773","values":[{"x":[0,0],"y":0.9223062000000003},{"x":[0,1],"y":0.048043799999999755},{"x":[1,0],"y":0.016773799999999756},{"x":[1,1],"y":0.012876200000000244}]}],"marks":[{"type":"rect","from":{"data":"f5e13766-22e8-4256-9f18-82280889ec4a"},"properties":{"enter":{"y":{"scale":"y","field":"data.y"},"width":{"offset":-1,"scale":"x","band":true},"x":{"scale":"x","field":"data.x"},"y2":{"scale":"y","value":0}},"update":{"fill":{"value":"red"},"opacity":{"value":0.2}},"hover":{"fill":{"value":"#FF29D2"}}}},{"type":"rect","from":{"data":"9969195e-ef08-4973-846d-373ca920a773"},"properties":{"enter":{"y":{"scale":"y","field":"data.y"},"width":{"offset":-1,"scale":"x","band":true},"x":{"scale":"x","field":"data.x"},"y2":{"scale":"y","value":0}},"update":{"fill":{"value":"blue"},"opacity":{"value":0.2}},"hover":{"fill":{"value":"#FF29D2"}}}}]},"value":"#gorilla_repl.vega.VegaView{:content {:width 600, :height 370.8282, :padding {:bottom 20, :top 10, :right 10, :left 50}, :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"f5e13766-22e8-4256-9f18-82280889ec4a\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"f5e13766-22e8-4256-9f18-82280889ec4a\", :field \"data.y\"}}], :axes [{:scale \"x\", :type \"x\"} {:scale \"y\", :type \"y\"}], :data ({:name \"f5e13766-22e8-4256-9f18-82280889ec4a\", :values ({:x (0 0), :y 0.218757199999952} {:x (0 1), :y 0.17091220000004792} {:x (1 0), :y 0.340542800000048} {:x (1 1), :y 0.26978779999995206})} {:name \"9969195e-ef08-4973-846d-373ca920a773\", :values ({:x (0 0), :y 0.9223062000000003} {:x (0 1), :y 0.048043799999999755} {:x (1 0), :y 0.016773799999999756} {:x (1 1), :y 0.012876200000000244})}), :marks ({:type \"rect\", :from {:data \"f5e13766-22e8-4256-9f18-82280889ec4a\"}, :properties {:enter {:y {:scale \"y\", :field \"data.y\"}, :width {:offset -1, :scale \"x\", :band true}, :x {:scale \"x\", :field \"data.x\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"red\"}, :opacity {:value 0.2}}, :hover {:fill {:value \"#FF29D2\"}}}} {:type \"rect\", :from {:data \"9969195e-ef08-4973-846d-373ca920a773\"}, :properties {:enter {:y {:scale \"y\", :field \"data.y\"}, :width {:offset -1, :scale \"x\", :band true}, :x {:scale \"x\", :field \"data.x\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"blue\"}, :opacity {:value 0.2}}, :hover {:fill {:value \"#FF29D2\"}}}})}}"}
;; <=
...
;; @@
;; =>
;;; {"type":"vega","content":{"width":600,"height":370.82818603515625,"padding":{"bottom":20,"top":10,"right":10,"left":50},"scales":[{"name":"x","type":"ordinal","range":"width","domain":{"data":"a0a5a7e9-11f2-492c-8328-bd4803cdf049","field":"data.x"}},{"name":"y","range":"height","nice":true,"domain":{"data":"a0a5a7e9-11f2-492c-8328-bd4803cdf049","field":"data.y"}}],"axes":[{"scale":"x","type":"x"},{"scale":"y","type":"y"}],"data":[{"name":"a0a5a7e9-11f2-492c-8328-bd4803cdf049","values":[{"x":[0,0],"y":0.218757199999952},{"x":[0,1],"y":0.17091220000004792},{"x":[1,0],"y":0.340542800000048},{"x":[1,1],"y":0.26978779999995206}]},{"name":"2e0fd24c-272b-41ae-8ea7-0b6056b4d6e6","values":[{"x":[0,0],"y":0.28008009999999933},{"x":[0,1],"y":0.09543990000000065},{"x":[1,0],"y":0.47184990000000065},{"x":[1,1],"y":0.15263009999999932}]}],"marks":[{"type":"rect","from":{"data":"a0a5a7e9-11f2-492c-8328-bd4803cdf049"},"properties":{"enter":{"y":{"scale":"y","field":"data.y"},"width":{"offset":-1,"scale":"x","band":true},"x":{"scale":"x","field":"data.x"},"y2":{"scale":"y","value":0}},"update":{"fill":{"value":"red"},"opacity":{"value":0.2}},"hover":{"fill":{"value":"#FF29D2"}}}},{"type":"rect","from":{"data":"2e0fd24c-272b-41ae-8ea7-0b6056b4d6e6"},"properties":{"enter":{"y":{"scale":"y","field":"data.y"},"width":{"offset":-1,"scale":"x","band":true},"x":{"scale":"x","field":"data.x"},"y2":{"scale":"y","value":0}},"update":{"fill":{"value":"blue"},"opacity":{"value":0.2}},"hover":{"fill":{"value":"#FF29D2"}}}}]},"value":"#gorilla_repl.vega.VegaView{:content {:width 600, :height 370.8282, :padding {:bottom 20, :top 10, :right 10, :left 50}, :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"a0a5a7e9-11f2-492c-8328-bd4803cdf049\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"a0a5a7e9-11f2-492c-8328-bd4803cdf049\", :field \"data.y\"}}], :axes [{:scale \"x\", :type \"x\"} {:scale \"y\", :type \"y\"}], :data ({:name \"a0a5a7e9-11f2-492c-8328-bd4803cdf049\", :values ({:x (0 0), :y 0.218757199999952} {:x (0 1), :y 0.17091220000004792} {:x (1 0), :y 0.340542800000048} {:x (1 1), :y 0.26978779999995206})} {:name \"2e0fd24c-272b-41ae-8ea7-0b6056b4d6e6\", :values ({:x (0 0), :y 0.28008009999999933} {:x (0 1), :y 0.09543990000000065} {:x (1 0), :y 0.47184990000000065} {:x (1 1), :y 0.15263009999999932})}), :marks ({:type \"rect\", :from {:data \"a0a5a7e9-11f2-492c-8328-bd4803cdf049\"}, :properties {:enter {:y {:scale \"y\", :field \"data.y\"}, :width {:offset -1, :scale \"x\", :band true}, :x {:scale \"x\", :field \"data.x\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"red\"}, :opacity {:value 0.2}}, :hover {:fill {:value \"#FF29D2\"}}}} {:type \"rect\", :from {:data \"2e0fd24c-272b-41ae-8ea7-0b6056b4d6e6\"}, :properties {:enter {:y {:scale \"y\", :field \"data.y\"}, :width {:offset -1, :scale \"x\", :band true}, :x {:scale \"x\", :field \"data.x\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"blue\"}, :opacity {:value 0.2}}, :hover {:fill {:value \"#FF29D2\"}}}})}}"}
;; <=
...
;; @@
(apply plot/compose (map #(plot/list-plot (map (fn [t] [t %]) (spike-trains %))
                                          :plot-range [[0 2e3] [0 2]] :plot-size 800) (range 7)))
;; @@
