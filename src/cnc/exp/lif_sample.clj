...
(comment
  ...
  (def weights #_(get-hdf5-tensor store #uuid "3760e2a2-7804-576f-8566-5c3d7fdde0a0" "/weight")
    [-1.23734581 -0.98058122 -0.89241827  2.11496282 -1.00997102 -1.64297628
     -0.67712694 -0.80782884 -0.67634469 -3.36467648 -0.39089906 -0.67717695
     -1.23734581 -0.67712694 -0.98058122 -0.80782884 -0.89241827 -0.67634469
     2.11496282 -3.36467648 -1.00997102 -0.39089906 -1.64297628 -0.67717695])
  (def biases [-1.74430096  1.39074838 -3.06545067 -2.7306788  -3.39792037  0.43532577
 -3.21678114 -2.86135125] #_(get-hdf5-tensor store #uuid "28a97297-2f9b-57e0-9564-70d24e93fdff" "/weight"))
...
;        biases (last (get-hdf5-tensor store (:bias_theo_history.h5 train) "/weight"))
    ...
    (def lif-sample-small
      (run-experiment! (partial setup-lif-sampling! store)
                       {:weights (partition 2 (drop 12 weights))
